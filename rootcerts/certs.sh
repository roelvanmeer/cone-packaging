cat >certs/aaa-certificate-services.pem <<...EOF...
Certificate:
    Data:
        Version: 3 (0x2)
        Serial Number: 1 (0x1)
...
-----END CERTIFICATE-----
...EOF...
cat >certs/america-online-root-certification-00.pem <<...EOF...
Certificate:
    Data:
        Version: 3 (0x2)
        Serial Number: 1 (0x1)
...
-----END CERTIFICATE-----
...EOF...
cat >certs/america-online-root-certification-01.pem <<...EOF...
Certificate:
    Data:
        Version: 3 (0x2)
        Serial Number: 1 (0x1)
...
-----END CERTIFICATE-----
...EOF...
cat >certs/aol-time-warner-root-certification-00.pem <<...EOF...
Certificate:
    Data:
        Version: 3 (0x2)
        Serial Number: 1 (0x1)
...
-----END CERTIFICATE-----
...EOF...
cat >certs/aol-time-warner-root-certification-01.pem <<...EOF...
Certificate:
    Data:
        Version: 3 (0x2)
        Serial Number: 1 (0x1)
...
-----END CERTIFICATE-----
...EOF...
cat >certs/betrusted-root-ca-baltimore-implementation.pem <<...EOF...
Certificate:
    Data:
        Version: 3 (0x2)
...
-----END CERTIFICATE-----
...EOF...
cat >certs/betrusted-root-ca-entrust-implementation.pem <<...EOF...
Certificate:
    Data:
        Version: 3 (0x2)
...
-----END CERTIFICATE-----
...EOF...
cat >certs/betrusted-root-ca-rsa-implementation.pem <<...EOF...
Certificate:
    Data:
        Version: 3 (0x2)
        Serial Number:
...
-----END CERTIFICATE-----
...EOF...
cat >certs/chambers-of-commerce-root.pem <<...EOF...
Certificate:
    Data:
        Version: 3 (0x2)
        Serial Number: 0 (0x0)
...
-----END CERTIFICATE-----
...EOF...
cat >certs/geotrust-global-ca.pem <<...EOF...
Certificate:
    Data:
        Version: 3 (0x2)
...
-----END CERTIFICATE-----
...EOF...
cat >certs/global-chambersign-root.pem <<...EOF...
Certificate:
    Data:
        Version: 3 (0x2)
        Serial Number: 0 (0x0)
...
-----END CERTIFICATE-----
...EOF...
cat >certs/ips-ca-chained-cas-certification.pem <<...EOF...
Certificate:
    Data:
        Version: 3 (0x2)
        Serial Number: 0 (0x0)
...
-----END CERTIFICATE-----
...EOF...
cat >certs/ips-ca-clase1-certification-authority.pem <<...EOF...
Certificate:
    Data:
        Version: 3 (0x2)
        Serial Number: 0 (0x0)
...
-----END CERTIFICATE-----
...EOF...
cat >certs/ips-ca-clase3-certification-authority.pem <<...EOF...
Certificate:
    Data:
        Version: 3 (0x2)
        Serial Number: 0 (0x0)
...
-----END CERTIFICATE-----
...EOF...
cat >certs/ips-ca-clasea1-certification-authority.pem <<...EOF...
Certificate:
    Data:
        Version: 3 (0x2)
        Serial Number: 0 (0x0)
...
-----END CERTIFICATE-----
...EOF...
cat >certs/ips-ca-clasea3-certification-authority.pem <<...EOF...
Certificate:
    Data:
        Version: 3 (0x2)
        Serial Number: 0 (0x0)
...
-----END CERTIFICATE-----
...EOF...
cat >certs/ips-ca-timestamping-certification.pem <<...EOF...
Certificate:
    Data:
        Version: 3 (0x2)
        Serial Number: 0 (0x0)
...
-----END CERTIFICATE-----
...EOF...
cat >certs/ips-servidores.pem <<...EOF...
Certificate:
    Data:
        Version: 1 (0x0)
        Serial Number: 0 (0x0)
...
-----END CERTIFICATE-----
...EOF...
cat >certs/netlock-expressz-class-c-tanusitvanykiado.pem <<...EOF...
Certificate:
    Data:
        Version: 3 (0x2)
...
-----END CERTIFICATE-----
...EOF...
cat >certs/netlock-kozjegyzoi-class-a-tanusitvanykiado.pem <<...EOF...
Certificate:
    Data:
        Version: 3 (0x2)
...
-----END CERTIFICATE-----
...EOF...
cat >certs/netlock-uzleti-class-b-tanusitvanykiado.pem <<...EOF...
Certificate:
    Data:
        Version: 3 (0x2)
...
-----END CERTIFICATE-----
...EOF...
cat >certs/quovadis-root-certification-authority.pem <<...EOF...
Certificate:
    Data:
        Version: 3 (0x2)
...
-----END CERTIFICATE-----
...EOF...
cat >certs/rsa-security-inc-rsa-security-1024.pem <<...EOF...
Certificate:
    Data:
        Version: 3 (0x2)
        Serial Number:
...
-----END CERTIFICATE-----
...EOF...
cat >certs/rsa-security-inc-rsa-security-2048.pem <<...EOF...
Certificate:
    Data:
        Version: 3 (0x2)
        Serial Number:
...
-----END CERTIFICATE-----
...EOF...
cat >certs/secom-trust-net-security-communication.pem <<...EOF...
Certificate:
    Data:
        Version: 3 (0x2)
        Serial Number: 0 (0x0)
...
-----END CERTIFICATE-----
...EOF...
cat >certs/secure-certificate-services.pem <<...EOF...
Certificate:
    Data:
        Version: 3 (0x2)
        Serial Number: 1 (0x1)
...
-----END CERTIFICATE-----
...EOF...
cat >certs/sonera-class1-ca.pem <<...EOF...
Certificate:
    Data:
        Version: 3 (0x2)
...
-----END CERTIFICATE-----
...EOF...
cat >certs/sonera-class2-ca.pem <<...EOF...
Certificate:
    Data:
        Version: 3 (0x2)
...
-----END CERTIFICATE-----
...EOF...
cat >certs/staat-der-nederlanden-root-ca.pem <<...EOF...
Certificate:
    Data:
        Version: 3 (0x2)
...
-----END CERTIFICATE-----
...EOF...
cat >certs/starfield-technologies-inc-starfield.pem <<...EOF...
Certificate:
    Data:
        Version: 3 (0x2)
        Serial Number: 0 (0x0)
...
-----END CERTIFICATE-----
...EOF...
cat >certs/tdc-internet-tdc-internet-root.pem <<...EOF...
Certificate:
    Data:
        Version: 3 (0x2)
...
-----END CERTIFICATE-----
...EOF...
cat >certs/the-go-daddy-group-inc-go-daddy.pem <<...EOF...
Certificate:
    Data:
        Version: 3 (0x2)
        Serial Number: 0 (0x0)
...
-----END CERTIFICATE-----
...EOF...
cat >certs/trusted-certificate-services.pem <<...EOF...
Certificate:
    Data:
        Version: 3 (0x2)
        Serial Number: 1 (0x1)
...
-----END CERTIFICATE-----
...EOF...
cat >certs/utn-datacorp-sgc.pem <<...EOF...
Certificate:
    Data:
        Version: 3 (0x2)
        Serial Number:
...
-----END CERTIFICATE-----
...EOF...
cat >certs/utn-userfirst-client-authentication.pem <<...EOF...
Certificate:
    Data:
        Version: 3 (0x2)
        Serial Number:
...
-----END CERTIFICATE-----
...EOF...
cat >certs/utn-userfirst-hardware.pem <<...EOF...
Certificate:
    Data:
        Version: 3 (0x2)
        Serial Number:
...
-----END CERTIFICATE-----
...EOF...
cat >certs/utn-userfirst-network-applications.pem <<...EOF...
Certificate:
    Data:
        Version: 3 (0x2)
        Serial Number:
...
-----END CERTIFICATE-----
...EOF...
cat >certs/utn-userfirst-object.pem <<...EOF...
Certificate:
    Data:
        Version: 3 (0x2)
        Serial Number:
...
-----END CERTIFICATE-----
...EOF...
cat >certs/visa-ecommerce-root.pem <<...EOF...
Certificate:
    Data:
        Version: 3 (0x2)
        Serial Number:
...
-----END CERTIFICATE-----
...EOF...
cat >certs/xramp-global-certification-authority.pem <<...EOF...
Certificate:
    Data:
        Version: 3 (0x2)
        Serial Number:
